...
dim(up_sigFe_list_HH_vs_LD) # 369 genes
...
dim(up_sigFe_list_HH_vs_HD) # 370 genes
...
dim(down_sigFe_list_HH_vs_LD) # 131 genes
...
dim(down_sigFe_list_HH_vs_HD) # 130 genes
...
dim(up_sigFe_list_HD_vs_LD) # 202 genes
...
dim(up_sigFe_list_HH_vs_HD) # 203 genes
...
dim(down_sigFe_list_HD_vs_LD) # 298 genes
...
dim(down_sigFe_list_HH_vs_HD) # 297 genes
...
down_sigFe_list_HH_vs_HD <- down_sigFe_list_HH_vs_HD[,c(2,9)]
merged <- merge(down_sigFe_list_HD_vs_LD,down_sigFe_list_HH_vs_HD,by="Transcript") 
dim(merged) # 297 genes
...
up_sigFe_list_HH_vs_LD <- sigFe_list_merged %>% filter(LFC_HH_vs_LD > 0) 
dim(up_sigFe_list_HH_vs_LD) # 229 genes
...
dim(up_sigFe_list_HD_vs_LD) # 229 genes
...
dim(down_sigFe_list_HH_vs_LD) # 271 genes
...
dim(down_sigFe_list_HD_vs_LD) # 271 genes

# find features upregulated in HH corals relative to both HD and LD corals
names(up_sigFe_list_HH_vs_LD)
down_sigFe_list_HH_vs_LD <- down_sigFe_list_HH_vs_LD[,c(1,9)]
down_sigFe_list_HD_vs_LD <- down_sigFe_list_HD_vs_LD[,c(1,9)]
merged <- join(down_sigFe_list_HH_vs_LD,down_sigFe_list_HD_vs_LD,by="Transcript") 
dim(merged) # 271 genes
